...
<body>
  ...
  <form action="../procesos/actualizar_pais.php" method="post">
    <div class="container">
      <div class="row">
        <div class="col">
          ...
          <select name="listaPaises" id="listaPaises" class="form-select mt-2">
            ...
            <option value="<?php echo $id_continente; ?>" hidden></option>
          ...
          <br>
          <input type="text" class="form-control" value="<?php echo $items['nombre_pais'] ?>" name="txt_nombrePais" placeholder="Nombre del pais" aria-label="Username" aria-describedby="addon-wrapping">
          <br>
          <label for="">Url imagen de pais</label>
          <br>
          <input type="text" class="form-control" value="<?php echo $items['ruta_bandera']; ?>" name="txt_urlImagen" placeholder="Url imagen de pais" aria-describedby="addon-wrapping">
